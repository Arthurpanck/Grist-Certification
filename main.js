...
const LEVEL_META = {
  none: {
    ...
    next:   'Continuez les exercices Débutant pour obtenir votre première certification.',
    color:  'var(--grey)',
  },
  D: {
    medal:  '🥉',
    ...
    next:   'Poursuivez avec les exercices Intermédiaire pour passer au niveau supérieur.',
    color:  'var(--blue)',
  },
  I: {
    medal:  '🥈',
    ...
    next:   'Poursuivez avec les exercices Avancé pour décrocher la certification ultime.',
    color:  'var(--orange)',
  },
  A: {
    medal:  '🥇',
